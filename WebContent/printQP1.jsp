...
<body>
    ...
    <div class="question-paper"  >
       <img src="rcp_logo.jpg" >
        ...
        <h2 align="center" style="color:#26D701;">TERM TEST</h2>
        <h3 align="center">MAX MARKS:30</h3>
        ...
        <div class="question-container">
            ...
            try {
                PreparedStatement ps1 = con.prepareStatement("SELECT Que,marks,unit FROM questions_tbl WHERE sub=? AND unit IN (1,2) ORDER BY unit, marks DESC, RAND()");
                ps1.setString(1,sub);
